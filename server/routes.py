...
from topo import locator, utc, create_location
...
def ephemeris():
    ...
    if form.validate_on_submit():
        ...
        if city:
            ...
            location = create_location(float(lng), float(lat))
        ...
        Chart(placidus, {**celestial, **lunar}, id=user_id).create_chart(show=False, save=True)
